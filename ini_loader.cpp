...
namespace util {
    namespace config {
        ...
        void ini_value::add(const char *begin, const char *end) { _data.push_back(std::string(begin, end)); }
        ...
        char ini_value::as_char(size_t index) const { return detail::str2int<char>(as_cpp_string(index).c_str()); }

        short ini_value::as_short(size_t index) const { return detail::str2int<short>(as_cpp_string(index).c_str()); }

        int ini_value::as_int(size_t index) const { return detail::str2int<int>(as_cpp_string(index).c_str()); }

        long ini_value::as_long(size_t index) const { return detail::str2int<long>(as_cpp_string(index).c_str()); }

        long long ini_value::as_longlong(size_t index) const { return detail::str2int<long long>(as_cpp_string(index).c_str()); }
        ...
        // ============ unsigned ============
        unsigned char ini_value::as_uchar(size_t index) const { return detail::str2int<unsigned char>(as_cpp_string(index).c_str()); }

        unsigned short ini_value::as_ushort(size_t index) const { return detail::str2int<unsigned short>(as_cpp_string(index).c_str()); }

        unsigned int ini_value::as_uint(size_t index) const { return detail::str2int<unsigned int>(as_cpp_string(index).c_str()); }

        unsigned long ini_value::as_ulong(size_t index) const { return detail::str2int<unsigned long>(as_cpp_string(index).c_str()); }

        unsigned long long ini_value::as_ulonglong(size_t index) const { return detail::str2int<unsigned long long>(as_cpp_string(index).c_str()); }

        int8_t ini_value::as_int8(size_t index) const { return detail::str2int<int8_t>(as_cpp_string(index).c_str()); }

        uint8_t ini_value::as_uint8(size_t index) const { return detail::str2int<uint8_t>(as_cpp_string(index).c_str()); }

        int16_t ini_value::as_int16(size_t index) const { return detail::str2int<int16_t>(as_cpp_string(index).c_str()); }

        uint16_t ini_value::as_uint16(size_t index) const { return detail::str2int<uint16_t>(as_cpp_string(index).c_str()); }

        int32_t ini_value::as_int32(size_t index) const { return detail::str2int<int32_t>(as_cpp_string(index).c_str()); }

        uint32_t ini_value::as_uint32(size_t index) const { return detail::str2int<uint32_t>(as_cpp_string(index).c_str()); }

        int64_t ini_value::as_int64(size_t index) const { return detail::str2int<int64_t>(as_cpp_string(index).c_str()); }

        uint64_t ini_value::as_uint64(size_t index) const { return detail::str2int<uint64_t>(as_cpp_string(index).c_str()); }
        ...
        int ini_loader::load_file(const std::string &file_path, bool is_append) { return load_file(file_path.c_str(), is_append); }
        ...
        void ini_loader::set_section(const std::string &path) { _current_node_ptr = &get_node(path, &get_root_node()); }
